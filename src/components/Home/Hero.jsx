...
function Hero() {
    return (
        <section className="relative bg-hero-pattern bg-cover bg-center" style={{ backgroundImage: `url(${bgImg})` }}>
            <div className="max-w-7xl mx-auto px-4 py-20 grid md:grid-cols-2 gap-10 items-center">
                <div>
                    <h1 className="text-5xl font-extrabold text-gray-900 sm:text-3xl">
