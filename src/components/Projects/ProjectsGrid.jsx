        ...
        <section className="max-w-7xl mx-auto px-4 py-16">
            <div className="grid md:grid-cols-3 gap-8">
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-semibold text-gray-900">Installation d’une ligne de production automatisée</h3>
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-semibold text-gray-900">Modernisation d’équipements électriques</h3>
                        <p className="text-gray-600 mt-2">
                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="p-6">
                        <h3 className="text-xl font-semibold text-gray-900">Maintenance préventive</h3>
                        <p className="text-gray-600 mt-2">
