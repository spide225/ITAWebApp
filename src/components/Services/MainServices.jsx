  ...
  return (
    <section className="max-w-7xl mx-auto px-4 py-16 grid md:grid-cols-2 gap-10">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col">
        ...
        <h2 className="text-xl font-semibold text-gray-900">Ingénierie Électrotechnique</h2>
      ...
      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col">
        ...
        <h2 className="text-xl font-semibold text-gray-900">Maintenance Industrielle</h2>
        <p className="mt-2 text-gray-700">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col">
        ...
        <h2 className="text-xl font-semibold text-gray-900">Automatisation</h2>
        <p className="mt-2 text-gray-700">
      ...
      <div className="bg-white rounded-xl shadow-md p-6 flex flex-col">
        ...
        <h2 className="text-xl font-semibold text-gray-900">Conseil & Assistance</h2>
        <p className="mt-2 text-gray-700">
